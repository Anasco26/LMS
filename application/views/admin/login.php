		...
		<div class="page-content vertical-align-middle">
			...
			<form method="post" action="<?php echo site_url();?>login/ceklogin" name="formLogin" id="form" parsley-validate novalidate>
				...
				<div class="form-group">
					...
					<input type="text" required class="form-control" name="username" autofocus id="user" placeholder="Username">
				</div>
				<div class="form-group">
				...
				<div class="signup"><button type="submit" class="btn btn-info rounded-0" name="masuk">Login</button></div>
			</form>
			<footer class="page-copyright">
				<p><?php echo $web->identitas_author;?> © <?php echo date('Y');?></p>
			</footer>
		</div>
	</div>
	<!-- End Page -->
