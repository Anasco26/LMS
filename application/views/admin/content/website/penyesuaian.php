						...
						<div class="panel-body container-fluid table-detail">
							<div class="table-full table-view">
								...
								<?php if($row->status_pergerakan == 1) { ?>
									<small class="badge badge-success bg-success rounded-pill" style="text-decoration: none">Incoming Goods</small>
									<?php } else { ?>
										
									<small class="badge badge-danger bg-danger rounded-pill" style="text-decoration: none">Outgoing Goods</small>
									<?php } ?>
								</td>
												<td>
