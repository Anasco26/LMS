...
<div class="page">
                                ...
                                <form action="" method="post" id="form">
                                    ...
                                    <div class='btn-navigation'>
                                        <div class='pull-right'>
                                            <a class="btn btn-success" href="<?php echo site_url();?>users/users">
	                            ...
	                            ?>
                                        <tr>
                                            ...
                                            <td class="text-center action">
                                                ...
                                                <a class="btn-update" href="<?php echo site_url();?>users/users/accept/<?php echo $row->admin_user;?>">
                                                    <i class="icon wb-check"></i>
                                                </a>
                                                <?php } else { ?>
                                                <a class="btn-update" href="<?php echo site_url();?>users/users/reject/<?php echo $row->admin_user;?>">
                                                    <i class="icon wb-close"></i>
                                                </a>
                                                <?php } ?>
                                                <a class="btn-update" href="<?php echo site_url();?>users/users/edit/<?php echo $row->admin_user;?>">
                                ...
                                <div class="paging">
                                    <div id='pagination'>
                                        <div class='pagination-right'>
                                            <ul class="pagination">
                                                <?php if ($jml_halaman > 1) { echo pages($halaman, $jml_halaman, 'users/users/view', $id=""); }?>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
    ...
    <?php if ($admin->admin_level_kode == 1) { ?>
    <a href="<?php echo site_url();?>users/users/tambah">
            ...
            <div class="col-md-12">
                <div class="panel rounded-0">
                    ...
                    <div class="panel-body container-fluid">
                        <form action="<?php echo site_url();?>users/users/tambah" method="post" id="exampleStandardForm" autocomplete="off">
                            ...
                            <div class='button center'>
                                ...
                                <input class="btn btn-danger btn-sm" type="reset" name="batal" value="Cancel" onclick="location.href='<?php echo site_url(); ?>users/users'"
                                />
                            </div>
                        </form>
                    </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="panel rounded-0">
                    ...
                    <div class="panel-body container-fluid">
                        <form action="<?php echo site_url();?>users/users/edit/<?php echo $admin_user;?>" method="post" id="exampleStandardForm"
                            autocomplete="off">
