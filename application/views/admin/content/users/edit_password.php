            ...
            <div class="col-md-12">
                <div class="panel rounded-0">
                    ...
                    <div class="panel-body container-fluid">
                        <form action="<?php echo site_url();?>users/edit_password/<?php echo $admin_user;?>" method="post" enctype="multipart/form-data" id="exampleStandardForm"
                            autocomplete="off">
                            ...
                            <div class="form-group form-material">
                                ...
                                <input type="password" class="form-control input-sm" id="admin_pass_recent" name="admin_pass_recent" placeholder="Enter Current Password" required />
                            </div>
                            <div class="form-group form-material">
                                <label class="control-label" for="inputText">New Password</label>
                                <input type="password" class="form-control input-sm" id="admin_pass" name="admin_pass" placeholder="Enter New Password" required />
                            </div>
                            <div class="form-group form-material">
                                <label class="control-label" for="inputText">Repeat Password</label>
                                <input type="password" class="form-control input-sm" id="admin_pass_ulang" name="admin_pass_ulang" placeholder="Repeat Password" required />
                            </div>
                            <div class='button center'>
                                <input class="btn btn-success btn-sm" type="submit" name="simpan" value="Add Data" id="">
                            </div>
                        </form>
                    </div>
                </div>
